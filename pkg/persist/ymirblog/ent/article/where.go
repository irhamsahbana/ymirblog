...
func BodyIsNil() predicate.Article {
	return predicate.Article(sql.FieldIsNull(FieldBody))
}

// BodyNotNil applies the NotNil predicate on the "body" field.
func BodyNotNil() predicate.Article {
	return predicate.Article(sql.FieldNotNull(FieldBody))
}
